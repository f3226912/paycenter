...
<body>
	<table id="refunddg" title="">
	</table>
	<div id="refundtb" style="padding:5px;height:auto">
		<form id="refundSearchForm" method="post">
		<div>
			违约金支出方：
        ...
        <gd:btn btncode='BTNWYJSY01'><a class="easyui-linkbutton" iconCls="icon-search" id="icon-searchList" OnClick ="return $('#refundSearchForm').form('validate');">查询</a></gd:btn>&nbsp;&nbsp;
        </div>
        
			<div style="background:#efefef;padding:5px 0 5px 0;height:25px;">
			<div style="float: left;font-size:14px;margin-left:5px;">违约金收益</div>
			<div style="float:right;margin-right:10px;">
					<gd:btn btncode='BTNWYJSY02'>	
...
<script type="text/javascript" src="${CONTEXT}js/profit/refund.js"></script>
