...
public class GuangxiPosNotifyTest {
	
	//private static String URL = "http://localhost:8080/paycenter-web-gateway/gxrcb/";
	
	private static String URL = "http://10.17.1.203:8311/gxrcb/";
	
	@Test
	public void test正向刷卡(){
		NanningPayNotifyDto dto = new NanningPayNotifyDto();
		
		dto.setMachinenum("00071612");
		dto.setMerchantnum("113420151310205");
		dto.setOrderfee("12300"); //单位 分 
		dto.setOrderno("182015000000005");
		dto.setPaycardno("1234567890");
		dto.setPayfee("100000023");
		dto.setRatefee("10");
		dto.setTransdate("20161118");
		dto.setTranstime("115900");
		dto.setPayresultcode("0000");
		dto.setTransseqno("20161129002");
		dto.setTransype("0");
	...
	private String signMsg(String data){
