...
import cn.gdeng.paycenter.entity.pay.BillCheckLogEntity;
 ...
 *
 */
public class DataBaseReflectXml {
	...
	public DataBaseReflectXml (Class<?> clazz) throws Exception {
		this.clazz = clazz;
		getTableName();
		getClassId();
		getClassProperties();
	...
	public static void main(String[] args) throws Exception {
		DataBaseReflectXml reflect = new DataBaseReflectXml(PayTypeEntity.class);
